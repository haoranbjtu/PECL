...
class RWGNN_mb_layer(nn.Module):
    def __init__(self,
                 num_metapaths,
                 num_edge_type,
                 etypes_list,
                 ...
                 rnn_type='gru',
                 attn_drop=0.5):
        super(RWGNN_mb_layer, self).__init__()
        self.in_dim = in_dim
        ...
        self.ctr_ntype_layer = Paths_att_aggre(num_metapaths,
                                                        etypes_list,
                                                        in_dim,
                                                        num_heads,
                                                        attn_vec_dim,
...
class RWGNN_mb(nn.Module):
    def __init__(self,
        ...
        # MAGNN_nc_mb layers
        self.layer1 = RWGNN_mb_layer(num_metapaths,
                                        num_edge_type,
                                        etypes_list,
                                        hidden_dim,
                                        out_dim,
